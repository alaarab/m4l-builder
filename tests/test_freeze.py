...
"Freeze Device" and parsed by an independent reference parser. The minimal
parser below mirrors that reference (``freezing_utils.parse_footer`` /
...
# --- Minimal self-contained reference parser --------------------------------
