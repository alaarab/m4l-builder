...
class TestLiveText:
    ...
    def test_automation_labels_mirror_enum(self):
        ...
        # BOX-level automation/automationon attrs (corpus: premium EQs/channel-strip
        # devices) — parameter_enum alone leaves "val1"/"val2" showing in
...
class TestTextedit:
    ...
    def test_corpus_attrs_set_when_provided(self):
        # MEASURED corpus attrs the prior stub omitted
...
class TestLiveStep:
    """Tests for live_step() — corpus-measured (4 lanes)."""
...
class TestLiveGrid:
    """Tests for live_grid() — corpus-measured (12×12, 32×32)."""
