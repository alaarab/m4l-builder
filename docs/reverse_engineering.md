...
structure into a higher-level `poly_editor_bank` grouping; the session-mapping
randomizer is the current proof device for that lane.
...
- a session-mapping-randomizer-style mapper
