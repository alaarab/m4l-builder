...
(pro-plugin-style) while staying a normal Live parameter.
...
def custom_glyph_selector_js(
    *,
    ...
    """A compact row of small hand-drawn GLYPH buttons for mode selection.
    ...
    ``vertical=True`` stacks the cells top-to-bottom; output is byte-identical
    when False.
    """
    from .ui_icons import ui_icons_js
...
def custom_slider_js(
    *,
    ...
    """A premium hand-drawn fader (pro-plugin-style): recessed track + accent fill
