...
Deconstructed from dnksaus_Rnd_Gen's obj-74 (circular dropdown) + obj-76 (rotated
...
_TEMPLATE = r"""// settings_bar: left-edge dropdown opener + rotated label (Rnd_Gen idiom)
mgraphics.init();
