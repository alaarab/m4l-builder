...
drag drives param Y (FabFilter Pro-Q band, compressor threshold/ratio dot, filter
...
def drag_curve_node_js(
    *,
    ...
    return (
        ...
        "    outlet(0, vx); outlet(1, vy);\n"  # Pro-Q reset: emit BOTH so both params record
        "    mgraphics.redraw();\n"
        "}\n"
        ...
        # hover/drag crosshair + gutter readouts (Pro-Q style)
        "    if (hover || dragging) {\n"
