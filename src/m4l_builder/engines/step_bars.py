"""Step-bar lane editor for jsui (catalog kit engines #7-#8).

A gate/random step lane, kit-native: N vertical bars in a dark
plot (a boutique device ships this as a raw ``multislider`` -- Auto_Gate's 8-slot rate
