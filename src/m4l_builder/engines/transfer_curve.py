"""Compressor/saturator transfer-curve display (premium-comp-style hero graph).
...
def transfer_curve_js(
    *,
    ...
    # The premium-comp "lit" segment that brightens the curve up to the live input
    ...
    return design_system_js() + "\n" + _JS_TEMPLATE.substitute(
        ...
        plot_geometry_short_js(
            "MARGIN_L",
            "mgraphics.size[0] - MARGIN_R - GR_BAR_W - 6",
            "MARGIN_T",
...
function paint() {
    ...
    // Live "lit" segment (premium-comp style): the transfer curve brightens from the
    ...
    // Live IO dot riding the curve — a glowing "operating point" (premium-comp/premium-limiter).
...
// Shift = fine-adjust (premium-EQ/premium-comp tactile grammar): threshold eases 15% toward
