...
def live_modulate(id_prefix: str, *, depth: float = 1.0) -> tuple:
    ...
    Standard shape: 2 inlets — modulation signal
...
def retargetable_param_sink(id_prefix: str, *, default_mode: int = 0,
    ...
    """The retarget sink: one ``id <n>`` stream drives
