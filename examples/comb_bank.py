...
# --- Device setup ---
device = AudioEffect("Comb Resonator", width=300, height=195, theme=MIDNIGHT)

# --- UI ---
device.add_panel("bg", [0, 0, 300, 195], bgcolor=[0.10, 0.10, 0.12, 1.0])
...
device.add_line("hp_dial", 0, "hp_l", 1)       # HP freq → svf_l cutoff
device.add_line("hp_dial", 0, "hp_r", 1)       # HP freq → svf_r cutoff
...
device.add_line("damp_dial", 0, "damp_l", 1)
device.add_line("damp_dial", 0, "damp_r", 1)
