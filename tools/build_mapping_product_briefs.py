"""Build mapping/modulation product briefs for a local AMXD corpus."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Maximum number of product briefs to include",
    )
    parser.add_argument(
        "--non-recursive",
        action="store_true",
    ...
    briefs = build_mapping_product_briefs(report, limit=args.limit)
